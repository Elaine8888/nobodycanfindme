            ...
            scenes: [
              {
                ...
                vocab: [
                  ...
                  "individual guidance — 一对一指导",
                  "gym floor plan — 健身房平面图"
                ]
              },
              {
                id: 2,
                ...
                vocab: [
                  ...
                  "saw — 锯子",
                  "screwdriver — 螺丝刀",
                  "carpentry machines — 木工机械",
                  "sand paper — 砂纸",
                  "supplies — 物料 / 耗材",
                  "last all quarter — 支撑整个学期使用"
                ]
              },
              {
                id: 3,
              ...
              },
              {
                ...
                vocab: [
                  "campus tour — 校园参观",
                  "enrollment office — 招生办公室",
                  "library — 图书馆",
                  "cafeteria — 食堂 / 自助餐厅",
                  "meal options — 餐食选择",
                  "university lecture halls — 大学报告厅",
                  "information desk — 咨询台",
                  "event schedule — 活动日程表",
              ...
              },
              {
                ...
                vocab: [
                  ...
                  "course catalog — 课程目录",
                  "Schedule Planner tool — 课程表规划工具",
                  "time conflicts — 时间冲突",
                  "pop up message — 弹出提示框",
                  "instructor — 导师；教练",
                  "add seats — 增加名额",
                  "add or drop classes — 加课或退课",
                  "new semester — 新学期",
                  "for your records — 供你留存记录"
                ]
              }
            ]
          }
